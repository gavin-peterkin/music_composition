...
It would be incredibly helpful for any galvanizers viewing this to participate in
what should be an incredibly short, fun survey.
...
actual music, and the rest are some combination. It's your task to estimate a percent randomness
for each sample.

<audio controls="controls">
  <source type="audio/ogg" src="/audio/sample_1.ogg">Sample 1</source>
